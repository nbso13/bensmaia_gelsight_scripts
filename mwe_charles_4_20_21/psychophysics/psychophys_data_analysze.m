...
%     "210216_wool_blend_no_gel_processed", ...
%     "210423_velour_no_gel_processed", ...
%     "210423_no_gel_thick_corduroy_processed"]; %100 gram textures
...
%%
x_axis = {sd, ts_sd, gel_sd, comp_ratio, sd_ratio, comp_ratio_ts, sd_ratio_ts, raw_gel_sd_ratio};
titstrs = {"Raw SD", "TS SD", "Gel SD",  "Gel IQR ratio", "Gel SD ratio", "TS IQR ratio", "TS SD ratio", "Gel Full SD Ratio"};
num_participants = 8;
