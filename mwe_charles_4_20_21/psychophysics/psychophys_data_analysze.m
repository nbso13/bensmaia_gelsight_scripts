...
switch name_str
    case 'all'
        ...
        texture_nums = [31, 25, 45, 7, 4, 42, 33, 9, 21, 38, 44, 6, 15, 2, 43, 20, 49, 50, 55];
    ...
    case 'compliant'
        ...
        filename_nogel = ["210121_velvet_no_gel_processed", ...
            ...
            "210729_snowflake_fuzzyside_no_gel_processed", ...
            "210729_microsuede_no_gel_processed"];
        texture_nums = [31, 25, 45, 7, 4, 33, 9, 21, 38, 44, 6, 15, 2, 43, 20]; % adding chiffon, suedeside sueded cuddle, satin, 
