function [FRs_ts, FRs_gel, response_collection, aff_pop_final, len_scan] = pullResponses(gel, ...
    no_gel, ppm, top_neuron_number, amplitudes, len, speed, pin_radius, aff_density, ...
