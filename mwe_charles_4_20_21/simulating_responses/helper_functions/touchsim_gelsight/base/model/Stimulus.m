...
classdef Stimulus < handle
    ...
    properties(SetAccess = private)
        ...
        S1                                                  
        gel_flag = 0;                                       % boolean indicating whether 
                                                            % to treat pins as skin profile or as  texture
    ...
    methods
        ...
        % constructor
        function obj = Stimulus(trace,location,sampling_frequency,pin_radius, gel_flag)
            if nargin>4
                obj.gel_flag = gel_flag;
            end
            if nargin>3
        ...
        function compute_profile(obj)
            if(obj.initialized)
                [obj.profile, obj.profiledyn] = CircIndent2LoadProfile...
                    ...
                    obj.sampling_frequency,obj.pin_radius, obj.gel_flag);
            end
        end
