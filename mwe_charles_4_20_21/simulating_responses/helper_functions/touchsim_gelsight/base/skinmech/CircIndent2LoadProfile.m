% function CircIndent2LoadProfile GELSIGHT MOD
%
...
% if gel_flag == 1, this means that S0 is from gelsight, i.e., skin
% modeling is not necessary (as this is done already by the gel).
% Therefore, S0 is really S1 and we solve for P by computing S0*D^-1

function [P, Pdyn,S1] = CircIndent2LoadProfile(S0,xy,samp_freq,ProbeRad, gel_flag)
