...
%date - July 15 2021
%% Load data
file_names = { "210730_satin_gel_B5_3", "210730_chiffon_no_gel", "210730_chiffon_gel_B5_3"};
gel_id = [ 1, 0, 1]; %1 if gel 0 if nah
...
for index = 1:length(file_names)
    ...
    cd ../bensmaia_gelsight_scripts/mwe_charles_4_20_21/simulating_responses
