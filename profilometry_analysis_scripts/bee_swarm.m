% charles bee swarm function
function bee_swarm(group_data, x, group_color, max_points)
    ks_underlay = false;
    group_mean = nanmedian(group_data, 'all');
    ...
    for bin = 1:n_bins
        ...
        scatter(x_vals, y_vals, 10, 'MarkerFaceColor', group_color, 'MarkerEdgeColor', group_color,'MarkerFaceAlpha', 0.15);
        dp_ind = dp_ind + group_hist(bin) - 1;
    end
