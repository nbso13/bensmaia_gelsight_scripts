...
filename_gel = ["210304_1mm_grating_gel_11_100_grams_processed",...
...
gel_weight = 100;
gel_num = 0;
texture_type = "noncompliant"; %compliant, noncompliant, or combined
